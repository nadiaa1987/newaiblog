    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-100 p-8 space-y-8">
        <div className="text-center">
          ...
          <p className="text-slate-500">Create your account and start building blogs with AI.</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          ...
          <Button type="submit" className="w-full py-6 text-lg" disabled={loading}>
            {loading ? <><Loader2 className="animate-spin mr-2" /> Creating account...</> : <><UserPlus className="mr-2" size={20} /> Create Account</>}
          </Button>
        </form>
